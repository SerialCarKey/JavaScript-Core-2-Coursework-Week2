function populateTodoList(todos) {
  ...
  for (let i = 0; i < todos.length; i++) {
    ...
    li2El.className = "list-group-item d-flex justify-content-between align-items-center";
    ...
    checkBtn.addEventListener("click", () => {
      if (li2El.style.textDecoration === "line-through") {
        todos[i].completed = false;
        li2El.style.textDecoration = "";
      } else {
        todos[i].completed = true;
        li2El.style.textDecoration = "line-through";
      }
    });
